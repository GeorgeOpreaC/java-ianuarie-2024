...
//        persoana2.name = "Alex 2";
//        persoana2.age = 22;
//
//        System.out.println("Varsta este : + persoana age");
...
//        Bloc bloc3 = new Bloc(true, 2005, 12);
//
//        Contract contract1 = new Contract("public", "electronic", 12);
//        Contract contract2 = new Contract("privat", "electronic", 15);
//        Contract contract3 = new Contract("privat", "electronic", 20);
//
